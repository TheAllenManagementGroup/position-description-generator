...
public class PdService {
    ...
    String positionTitle = request.getSubJobSeries() != null ? request.getSubJobSeries() : "Management Analyst";
    ...
    return String.format("""
        ...
        **TITLE AND SERIES DETERMINATION:**
        ...
        If you believe a different job series or title is more accurate based on the duties, explain your rationale in this section. Otherwise, use the user's chosen values.
        User Chosen Job Series: GS-%s
        User Chosen Position Title: %s
        ...
        **FAIR LABOR STANDARDS ACT DETERMINATION:**
        ...
        federalAgency, subOrganization, lowestOrg, positionTitle,
        gsGrade, positionTitle,
        factorSection
    );
}
