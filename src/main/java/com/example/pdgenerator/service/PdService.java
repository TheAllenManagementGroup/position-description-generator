...
public String fixPDFormatting(String pdText) {
    ...
    // === CRITICAL FIX: Handle Factor4A and Factor4B FIRST with simple string replacement ===
    // This catches the exact malformed pattern before any other processing
    ...
    // Also handle other common malformed Level patterns
