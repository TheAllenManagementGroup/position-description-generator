...
public class PdService {
    ...
    section.append("For EACH of the 9 factors, write 2-5 detailed sentences explaining the following:\n");
    ...
    section.append("Use this EXACT header format for each factor (note the spaces between words and numbers):\n");
    section.append("**Factor [number] – [name] Level [level], [points] Points**\n\n");
    section.append("═══════════════════════════════════════════════════════\n");
    section.append("LOCKED FACTOR VALUES (copy these EXACTLY with proper spacing):\n");
    section.append("═══════════════════════════════════════════════════════\n\n");
    ...
    for (int i = 1; i <= 9; i++) {
        ...
        section.append("[Write 2-5 detailed sentences explaining this factor level based on the position duties]\n\n");
    }
    ...
    section.append("- Copy the factor headers EXACTLY as shown above with spaces (e.g., 'Factor 3 – Guidelines Level 3-3, 275 Points')\n");
    ...
    - Factor headers MUST use this exact format with spaces: **Factor 3 – Guidelines Level 3-3, 275 Points** (spaces between all words and numbers).
    ...
    - Each variable in the **HEADER** section MUST appear on its own separate line with a blank line between each item.
    """;
