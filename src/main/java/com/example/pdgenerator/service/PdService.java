...
""",
    ...
    try {
        ...
        messages.add(new Message("system",
            ...
            "🚨🚨🚨 CRITICAL SPACING REQUIREMENTS - FAILURE TO FOLLOW WILL BREAK THE DOCUMENT 🚨🚨🚨\n\n" +
            
            "RULE 1: ALWAYS write 'Factor 4A' with a SPACE after 'Factor'\n" +
            "✅ CORRECT: **Factor 4A – PERSONAL CONTACTS (NATURE OF CONTACTS) Level 4-4, 100 Points**\n" +
            "❌ WRONG: **Factor4A – PERSONAL CONTACTS (NATURE OF CONTACTS) Level4-4,100 Points**\n\n" +
            
            "RULE 2: ALWAYS write 'Factor 4B' with a SPACE after 'Factor'\n" +
            "✅ CORRECT: **Factor 4B – PERSONAL CONTACTS (PURPOSE OF CONTACTS) Level 4-4, 125 Points**\n" +
            "❌ WRONG: **Factor4B – PERSONAL CONTACTS (PURPOSE OF CONTACTS) Level4-4,125 Points**\n\n" +
            
            "RULE 3: ALWAYS write 'Level X-X, XXX Points' with spaces\n" +
            "✅ CORRECT: Level 4-4, 100 Points\n" +
            "❌ WRONG: Level4-4,100Points or Level4-4,100 Points\n\n" +
            
            "RULE 4: When you type Factor 4A or Factor 4B, PAUSE and verify:\n" +
            "  - Is there a space between 'Factor' and '4A'? ✓\n" +
            "  - Is there a space between 'Factor' and '4B'? ✓\n" +
            "  - Are there spaces in 'Level 4-4, 100 Points'? ✓\n\n" +
            
            "EXAMPLES OF CORRECT FORMATTING:\n" +
            "**Factor 1 – PROGRAM SCOPE AND EFFECT Level 1-3, 550 Points**\n" +
            "**Factor 2 – ORGANIZATIONAL SETTING Level 2-3, 350 Points**\n" +
            "**Factor 3 – SUPERVISORY & MANAGERIAL AUTHORITY EXERCISED Level 3-4, 900 Points**\n" +
            ...
            "DO NOT EVER WRITE:\n" +
            "- Factor4A (missing space)\n" +
            "- Factor4B (missing space)\n" +
            "- Level4-4,100 (missing spaces)\n" +
            "- Level4-4,125Points (missing spaces)\n\n" +
            
            "Every factor header you generate must have proper spacing. Check each one before moving on."
        ));
