...
public class PdService {
    ...
    // Build factor evaluation section with exact values if provided
    String factorSection = buildFactorSectionFromRequest(request);
    ...
    return String.format("""
        ...
        Create a COMPLETE, PROFESSIONAL federal position description using the EXACT format and level of detail shown in the provided DOE and DOJ samples.
        ...
        **INTRODUCTION:** (Substantial paragraph, 4-6 sentences)
        Write a comprehensive introduction explaining the position's critical role, organizational context, key responsibilities, and impact.

        **MAJOR DUTIES:**
        Create 3-4 comprehensive duty statements with realistic percentages totaling 100%%. Each duty should be 3-4 sentences with technical depth.

        **FACTOR EVALUATION - USE THESE EXACT VALUES:**
        
        %s

        **CONDITIONS OF EMPLOYMENT:**
        Create comprehensive sections for required certifications, security clearance, training requirements, and other special conditions.

        **TITLE AND SERIES DETERMINATION:**
        Write 2-3 detailed paragraphs explaining the rationale for the series assignment and title appropriateness.

        **FAIR LABOR STANDARDS ACT DETERMINATION:**
        Provide specific justification for exempt/non-exempt status with detailed reasoning.

        Generate a complete, comprehensive position description matching the professional quality of the DOE and DOJ samples.
        """,
        factorGuide, seriesGuide,
        jobSeries, subJobSeries,
        federalAgency, subOrganization, lowestOrg,
        gsGrade, totalPoints, gradeRange, supervisoryLevel, historicalData,
        federalAgency, subOrganization, lowestOrg, subJobSeries,
        gsGrade, subJobSeries,
        factorSection
    );
}
...
private String buildFactorSectionFromRequest(PdRequest request) {
    ...
    section.append("YOU MUST USE THESE EXACT FACTOR VALUES (DO NOT CHANGE):\n\n");
