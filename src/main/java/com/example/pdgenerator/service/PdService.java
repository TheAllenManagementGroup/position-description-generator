...
public class PdService {
    ...
    - Each variable in the **HEADER** section (Job Series, Position Title, Agency, Organization, etc.) MUST appear on its own line with a blank line between each item.
    DO NOT run section headers together with content or other headers. Always use blank lines.
    - When writing factor headers, always include a space between "Factor" and the number (e.g., "Factor 3", not "Factor3").
    """;
...
You must also have a new line before and after each section header (e.g. **HEADER**, **INTRODUCTION**, etc.) for clarity.
...
Create 5-7 specific sentences covering:
