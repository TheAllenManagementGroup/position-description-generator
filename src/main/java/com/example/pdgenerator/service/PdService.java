...
public class PdService {
    ...
    String factorSection = buildLockedFactorSection(request);
    ...
    return String.format("""
        ...
        ⚠️ CRITICAL: The factor evaluations below are FINAL and LOCKED. You MUST copy them EXACTLY as shown with the exact levels and point values. DO NOT recalculate or change any numbers.
        ...
        **INTRODUCTION:** (4-6 sentences)
        Write a comprehensive introduction explaining the position's role, organizational context, key responsibilities, and impact.
        ...
        **MAJOR DUTIES:** (Create 3-4 major duty areas with realistic percentages totaling 100%%)
        ...
        (3-4 sentences per duty with technical depth)
        ...
        **CONDITIONS OF EMPLOYMENT:**
        Create 6-8 specific bullet points covering:
        ...
        **TITLE AND SERIES DETERMINATION:**
        ...
        - Professional requirements justification

        **FAIR LABOR STANDARDS ACT DETERMINATION:**
        Provide justification for exempt/non-exempt status based on professional duties.

        Generate a complete position description matching the DOE/DOJ quality and depth.
        """,
        factorSection, gradeRange, totalPoints, factorGuide, seriesGuide,
        ...
        buildDetailedFactorInstructions(request)
    );
}
