...
- DO NOT use dashed lines or separators.
- Every section header (e.g., **HEADER**, **INTRODUCTION**, **MAJOR DUTIES**, etc.) MUST be bolded with double asterisks and start on a new line, with TWO blank lines before and after.
- Factor headers MUST use this format: **Factor [number] – [name] Level [level], [points] Points** (with spaces between words and numbers).
- All 9 factors MUST be displayed, each with its own header and justification paragraphs.
- Summary sections (Total Points, Final Grade, Grade Range) MUST each be on their own line, bolded, and separated by blank lines.
- DO NOT use bullet points, tables, or outlines; only numbered duties and prose paragraphs.
""";
...
(Write 3-4 major duties, each numbered, with percentage and a paragraph.)

**FACTOR EVALUATION - COMPLETE ANALYSIS**

(Write all 9 factors, each with header and justification paragraphs.)
...
(Write 2-3 sentences.)
""",
formattingInstructions, factorSection,
