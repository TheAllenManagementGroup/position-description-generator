...
public class PdService {
    ...
    - DO NOT use bullet points anywhere in the document.
    - Major duties must be numbered (e.g., 1. Duty Title (percentage)), each followed by a paragraph describing the duty, with each duty and paragraph on its own line.
    - Every section header (e.g., **HEADER**, **INTRODUCTION**, **MAJOR DUTIES**, etc.) MUST be bolded with double asterisks and start on a new line.
    ...
    - Factor headers MUST use this format: **Factor [number] – [name] Level [level], [points] Points** (with spaces between words and numbers, e.g., "**Factor 3 – Guidelines Level 3-3, 275 Points**").
    - After the last variable in the HEADER section, insert a blank line before the INTRODUCTION section.
    - DO NOT use tables, outlines, or bullet points; only numbered duties and prose paragraphs.
    """;
    ...
    return String.format("""
        ...
        **MAJOR DUTIES**
        ...
        List 3-4 major duty areas, each numbered (e.g., 1. Duty Title (percentage)), followed by a paragraph describing the duty. Each duty and paragraph must be on its own line. Do NOT use bullet points.

        Example:
        1. Real Estate Acquisition and Disposal (40%)
        Paragraph describing this duty...

        2. Lease Management (30%)
        Paragraph describing this duty...

        3. Advisory Services (30%)
        Paragraph describing this duty...

        **FACTOR EVALUATION - COMPLETE ANALYSIS**

        For each of the 9 factors, use this header format (with correct spacing):
        **Factor [number] – [name] Level [level], [points] Points**

        Then write 2-4 detailed paragraphs (4-6 sentences each) explaining:
        - What specific knowledge/skills/responsibilities this level requires
        - How the position meets this level through specific duty examples
        - Why this level is appropriate for the position
        ...
        **CONDITIONS OF EMPLOYMENT**
        ...
        Write 5-7 sentences describing conditions of employment. Do NOT use bullet points.
...
/**
 * Build factor section instruction with locked values - uniform format
 */
private String buildFactorSectionInstruction(PdRequest request) {
    ...
    section.append("You MUST use the EXACT factor values provided below. Do NOT recalculate or change them.\n\n");
    section.append("For EACH of the 9 factors, write 2-4 detailed paragraphs (4-6 sentences each) explaining:\n");
    section.append("1. What specific knowledge/skills/responsibilities this level requires\n");
    section.append("2. How the position meets this level through specific duty examples\n");
    section.append("3. Why this level is appropriate for the position\n\n");
    
    section.append("Use this EXACT header format for each factor, then write the detailed justification:\n");
    section.append("**Factor [number] – [name] Level [level], [points] Points**\n\n");
    section.append("═══════════════════════════════════════════════════════\n");
    section.append("LOCKED FACTOR VALUES (copy these EXACTLY):\n");
    section.append("═══════════════════════════════════════════════════════\n\n");

    // List all 9 factors with their locked levels and points
    for (int i = 1; i <= 9; i++) {
        ...
        section.append("[Write 2-4 detailed paragraphs explaining this factor level based on the position duties]\n\n");
    }

    section.append("═══════════════════════════════════════════════════════\n");
    section.append("**EVALUATION SUMMARY (copy these EXACTLY):**\n\n");
    ...
    section.append("- Copy the factor headers EXACTLY as shown above\n");
    section.append("- Do NOT change any levels or point values\n");
    section.append("- Write COMPLETE paragraph justifications for ALL 9 factors\n");
    section.append("- Each factor needs 2-4 paragraphs with specific examples from the position duties\n");
    section.append("- Do NOT create tables or summaries - only prose paragraphs\n");
    section.append("- Ensure all factors align with " + gsGrade + " level work\n");
