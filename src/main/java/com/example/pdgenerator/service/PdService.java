...
private int getMaxLevelForFactor(String factor) {
    ...
    // --- HEADER variable splitting: force each field onto its own line ---
    ...
    // --- Factor header fix: split level and points if run together (e.g., 1-81550 -> 1-8, 1550) ---
    // This will fix cases like "Level 1-81550" or "Level 1-8155, 0 Points"
    text = text.replaceAll(
