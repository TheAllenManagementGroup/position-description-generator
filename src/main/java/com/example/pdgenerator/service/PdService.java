...
public class PdService {
    ...
    return String.format("""
        ...
        You must include a blank line before and after each section header (e.g., **HEADER**, **INTRODUCTION**, etc.) for clarity.
        ...
        **INTRODUCTION**
        ...
        Write a comprehensive introduction (4-6 sentences) explaining:
        - The position's critical role within the organization
        - Organizational context and mission alignment
        - Key responsibilities and scope of authority
        - Impact on agency operations and programs
        - Specific technical requirements
        - Working relationships and collaboration requirements
        
        Match the depth and professionalism of the DOE/DOJ samples provided.

        **MAJOR DUTIES**
        
        Create 3-4 major duty areas with realistic percentages totaling 100%%.
        
        For EACH duty area, include:
        - Duty title and percentage of time
        - 4-6 bullet points describing specific tasks and responsibilities
        - Each bullet should be 3-4 detailed sentences covering:
          * Specific technical tasks and methodologies
          * Required knowledge and skills application
          * Processes and procedures followed
          * Professional interactions and coordination
        ...
        **CONDITIONS OF EMPLOYMENT:**
        Create 5-7 specific bullet points covering:
        ...
        **FAIR LABOR STANDARDS ACT DETERMINATION:**
        ...
        ✓ Generate a COMPLETE, COMPREHENSIVE position description
        ✓ Match the professional quality of DOE and DOJ samples
        ✓ Include substantial, specific content in every section
        ✓ Use proper spacing and formatting throughout
        ✓ NO placeholders or generic statements
        ✓ NO incomplete sections or outlines
        ✓ Ensure all factor evaluations are fully detailed with complete paragraph justifications
        ✓ Total document should be comprehensive and ready for immediate use
        """,
        // Position Information
        jobSeries, subJobSeries, federalAgency, subOrganization, lowestOrg, supervisoryLevel, historicalData,
        // Guidance sections
        factorGuide, seriesGuide, relevantFactors,
        // Header section
        jobSeries, subJobSeries, federalAgency, subOrganization, lowestOrg, supervisoryLevel,
        // Factor section with locked values
        factorSection,
        // Evaluation summary
        request.getTotalPoints(), gsGrade, request.getGradeRange(),
        // Title determination
        jobSeries
    );
}
