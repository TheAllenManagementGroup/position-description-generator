...
""",
    ...
    section.append("YOU MUST FOLLOW THIS EXACT FORMAT FOR EVERY SINGLE FACTOR:\n\n");
    section.append("CORRECT FORMAT:\n");
    section.append("**Factor 1 – PROGRAM SCOPE AND EFFECT Level 1-3, 550 Points**\n");
    section.append("(ONE blank line)\n");
    section.append("Description text here.\n");
    section.append("(TWO blank lines)\n\n");
    section.append("WRONG FORMATS TO AVOID:\n");
    section.append("❌ DO NOT write: **Factor1 – PROGRAM** (missing space after Factor)\n");
    section.append("❌ DO NOT write: **Factor4A – PERSONAL** (missing space after Factor)\n");
    section.append("❌ DO NOT write: Level1-3,550 (missing space after Level and before comma)\n");
    section.append("❌ DO NOT write: Level G:1-3,550 (DO NOT INCLUDE 'G:' PREFIX)\n");
    section.append("❌ DO NOT write: Level4-4,100 (missing space after Level)\n\n");
    section.append("REQUIRED SPACING RULES:\n");
    section.append("✓ Always: 'Factor 1' with a SPACE\n");
    section.append("✓ Always: 'Factor 4A' with a SPACE after Factor\n");
    section.append("✓ Always: 'Level 1-3, 550' with spaces around comma\n");
    section.append("✓ Always: ONE blank line after header before description\n");
    section.append("✓ Always: TWO blank lines after description before next factor\n");
    section.append("✓ Never use 'G:' in the output\n\n");
    section.append("═══════════════════════════════════════════════════════\n\n");

    // List the 6 GSSG factors with their locked levels and points
    // Remove G: prefix from the levels before inserting
    for (int i = 1; i <= 6; i++) {
        if (i == 4) {
    ...
    section.append("⚠️ MANDATORY REQUIREMENTS - READ CAREFULLY:\n");
    section.append("- Generate ALL 6 factors (1, 2, 3, 4A, 4B, 5, 6)\n");
    section.append("- EXACT FORMAT: **Factor N – NAME Level X-Y, ZZZ Points** (with spaces)\n");
    section.append("- NEVER write 'G:' prefix in output - only write level like '1-3, 550'\n");
    section.append("- NEVER write 'Factor1' - always write 'Factor 1' with a space\n");
    section.append("- NEVER write 'Factor4A' - always write 'Factor 4A' with a space\n");
    section.append("- NEVER write 'Level1-3,550' - always write 'Level 1-3, 550' with spaces\n");
    section.append("- ONE blank line after each header, THEN the description on a new line\n");
    section.append("- TWO blank lines after each description before the next factor header\n");
    section.append("- Do NOT change or alter any levels or point values - copy them exactly\n");
    section.append("- Description should be 2-5 sentences, no more, no less\n\n");
    section.append("EXAMPLE OF CORRECT FORMAT:\n");
    section.append("**Factor 1 – PROGRAM SCOPE AND EFFECT Level 1-3, 550 Points**\n\n");
    section.append("The incumbent oversees critical operations. This position has significant impact across the organization.\n\n\n");
    section.append("**Factor 4A – PERSONAL CONTACTS (NATURE OF CONTACTS) Level 4-4, 100 Points**\n\n");
    section.append("The incumbent interacts with senior personnel. These contacts require establishing effective working relationships.\n\n\n");
