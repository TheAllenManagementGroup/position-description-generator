...
""",
    ...
    section.append("1. Write the header on its own line with this EXACT structure:\n");
    section.append("   **Factor 1 – PROGRAM SCOPE AND EFFECT Level 1-3, 550 Points**\n");
    section.append("   (Notice: 'Factor 1' with a SPACE, dash with spaces around it, NO 'G:' prefix, comma with space before points)\n\n");
    section.append("2. Leave ONE BLANK LINE after the header\n\n");
    section.append("3. Write 2-5 sentences of explanation\n\n");
    section.append("4. Leave TWO BLANK LINES before the next factor header\n\n");
    section.append("FORBIDDEN: Do NOT write 'G:1-3' or 'G:1-3,550' - write only '1-3, 550'\n\n");
    section.append("═══════════════════════════════════════════════════════\n\n");
    ...
    for (int i = 1; i <= 6; i++) {
        if (i == 4) {
            ...
            // Show 4A/4B examples explicitly
            section.append("\nEXAMPLE FORMAT FOR FACTORS 4A AND 4B:\n");
            section.append("**Factor 4A – PERSONAL CONTACTS (NATURE OF CONTACTS) Level 4-4, 100 Points**\n\n");
            section.append("Write 2-5 sentences here.\n\n\n");
    ...
    section.append("- EXACT FORMAT: **Factor N – NAME Level X-Y, ZZZ Points** (with spaces around dashes)\n");
    section.append("- NEVER write 'G:' prefix in output - only write the level like '1-3, 550'\n");
    ...
    section.append("**Factor 2 – ORGANIZATIONAL SETTING Level 2-3, 350 Points**\n\n");
    section.append("The position operates within a large federal agency structure. Reports to executive leadership.\n\n\n");
...
""",
    ...
    // === FIX FACTOR HEADERS - THE CORE ISSUE ===
    
    // Step 1: Fix "Factor1" -> "Factor 1", "Factor4A" -> "Factor 4A", etc.
