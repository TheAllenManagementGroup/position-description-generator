...
%s
""",
formattingInstructions, jobSeries, positionTitle, gsGrade, federalAgency, subOrganization,
lowestOrg, supervisoryLevel, factorSection, jobSeries, summaryInstructions,historicalData, relevantFactors, seriesGuide, factorGuide
);
}
