...
public Map<String, Object> updateFactorPoints(@RequestBody Map<String, Object> payload) {
    try {
        ...
        // Detect which system (GSSG vs FES)
        ...
        // Fallback to parameter if inconclusive
        if (detection.get("reason") != null && String.valueOf(detection.get("reason")).startsWith("Defaulting")) {
            isSupervisory = isSupervisoryPosition(supervisoryLevel);
        }
