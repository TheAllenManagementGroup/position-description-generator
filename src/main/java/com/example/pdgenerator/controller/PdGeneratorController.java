...
private String calculateGradeRange(int totalPoints) {
    ...
    if (totalPoints >= 1105 && totalPoints <= 1350) return "1105-1350"; // GS-07
    if (totalPoints >= 1355 && totalPoints <= 1600) return "1355-1600"; // GS-09
    if (totalPoints >= 1605 && totalPoints <= 1850) return "1605-1850"; // GS-11
    if (totalPoints >= 1855 && totalPoints <= 2100) return "1855-2100"; // GS-12 low
    if (totalPoints >= 2105 && totalPoints <= 2350) return "2105-2350"; // GS-12 high
    if (totalPoints >= 2355 && totalPoints <= 2750) return "2355-2750"; // GS-13
    if (totalPoints >= 2755 && totalPoints <= 3150) return "2755-3150"; // GS-14
    if (totalPoints >= 3155 && totalPoints <= 3600) return "3155-3600"; // GS-15
    return "Unknown";
}
...
private String calculateFinalGrade(int totalPoints) {
    ...
    if (totalPoints >= 1855 && totalPoints <= 2350) return "GS-12";
