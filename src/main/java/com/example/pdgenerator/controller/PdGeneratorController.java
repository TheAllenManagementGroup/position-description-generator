...
public Map<String, String> generateEvaluationStatement(@RequestBody Map<String, String> body) throws Exception {
    ...
    promptBuilder.append("You are a federal HR classification specialist.\n")
        .append("Based on the following:\n")
        .append("- Job series: ").append(jobSeries).append("\n")
        .append("- Job title: ").append(jobTitle).append("\n")
        .append("- Position title: ").append(positionTitle).append("\n")
        .append("- Assigned grade: ").append(gsGrade).append("\n")
        .append("- Duties: ").append(duties).append("\n")
        .append("- Requirements: ").append(requirements).append("\n\n")
        .append("Write a full position evaluation statement including:\n")
        .append("1. Top recommended job series and position title\n")
        .append("2. 2–3 sentence background of the position\n")
        .append("3. 2–3 sentence title and series determination\n")
        .append("4. All 9 classification factors (Knowledge Required, Supervisory Controls, Guidelines, Complexity, Scope and Effect, Personal Contacts, Purpose of Contacts, Physical Demands, Work Environment)\n\n")
        .append("For each factor:\n")
        .append("- Assign a realistic OPM FES point value based on the grade using the following factor levels:\n")
        .append(FACTOR_POINTS.toString()).append("\n")
        .append("- Give a brief 2–3 sentence justification referencing the duties/requirements.\n")
        .append("- Clearly explain why this factor level fits the assigned grade, why it does NOT meet the next higher grade, and why it exceeds the lower grade.\n");

    String prompt = promptBuilder.toString();

    // Call OpenAI (or your AI service) with a timeout of 60 seconds
