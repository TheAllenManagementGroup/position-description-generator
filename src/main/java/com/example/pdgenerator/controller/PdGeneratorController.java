...
public Map<String, String> generateEvaluationStatement(@RequestBody Map<String, String> body) throws Exception {
    ...
    String prompt = String.format("""
        ...
        Write a full position evaluation statement including:

        1. Top recommended job series and position title
        2. 2–3 sentence background of the position
        3. 2–3 sentence title and series determination
        4. All 9 classification factors (Knowledge Required, Supervisory Controls, Guidelines, Complexity, Scope and Effect, Personal Contacts, Purpose of Contacts, Physical Demands, Work Environment)

        For each factor:
        - Assign a realistic OPM FES point value for this grade/series.
        - Give a **brief 2–3 sentence justification** referencing the duties/requirements.
        - Clearly state why this level fits the assigned grade, why it does NOT meet the next higher grade, and why it exceeds the lower grade.

        5. A 3–4 sentence summary explaining how total points fit in the official OPM point range for this grade, why it does not meet the next higher grade, and why it exceeds the lower grade.

        Keep writing concise and structured. Do NOT exceed 2–3 sentences per factor.
