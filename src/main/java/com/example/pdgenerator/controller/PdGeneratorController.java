...
public Map<String, String> generateEvaluationStatement(@RequestBody Map<String, String> body) throws Exception {
    ...
    String prompt = String.format("""
        ...
        Generate a concise federal position evaluation statement including:

        1. Top recommended job series and position title
        2. Brief 2–3 sentence background and title/series determination
        3. All 9 classification factors in short bullet format:
           - For each factor, assign realistic OPM FES points for this grade/series.
           - Give a brief 1–2 sentence justification.
           - State why it fits the assigned grade, why it does NOT meet the next higher grade, and why it exceeds the lower grade.
        4. A 2–3 sentence summary explaining total points and why the grade is correct.

        Keep bullets short. Avoid long paragraphs. Only provide the evaluation statement.
