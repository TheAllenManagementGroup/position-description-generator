...
public Map<String, Object> updateFactorPoints(@RequestBody Map<String, Object> body) throws Exception {
    ...
    // Build a detailed yet condensed prompt
    StringBuilder prompt = new StringBuilder();
    prompt.append("You are a federal HR specialist expert in OPM's Factor Evaluation System (FES). ");
    prompt.append("Analyze each factor's content and assign appropriate levels and points using official OPM standards, following the two-grade interval GS system (GS-5 to GS-15). ");
    prompt.append("Factor levels must match factor numbers and points must match OPM charts. Consider complexity, responsibility, and scope described in content.\n\n");

    prompt.append("FACTOR LEVEL-POINT REFERENCE:\n");
    prompt.append("Factor 1: 1-1=200,1-2=350,1-3=500,1-4=750,1-5=950,1-6=1250,1-7=1550,1-8=1850,1-9=2210\n");
    prompt.append("Factor 2: 2-1=25,2-2=125,2-3=275,2-4=450,2-5=650\n");
    prompt.append("Factor 3: 3-1=25,3-2=125,3-3=275,3-4=450,3-5=650\n");
    prompt.append("Factor 4: 4-1=25,4-2=75,4-3=150,4-4=225,4-5=325,4-6=450\n");
    prompt.append("Factor 5: 5-1=25,5-2=75,5-3=150,5-4=225,5-5=325,5-6=450\n");
    prompt.append("Factor 6: 6-1=10,6-2=25,6-3=60,6-4=110\n");
    prompt.append("Factor 7: 7-1=20,7-2=50,7-3=120,7-4=220\n");
    prompt.append("Factor 8: 8-1=5,8-2=20,8-3=50\n");
    prompt.append("Factor 9: 9-1=5,9-2=20,9-3=50\n\n");

    prompt.append("ANALYSIS GUIDELINES:\n");
    prompt.append("- Factor 1: depth/breadth of knowledge, education, specialization\n");
    prompt.append("- Factor 2: independence, supervision, review frequency\n");
    prompt.append("- Factor 3: clarity of guidelines, interpretation required\n");
    prompt.append("- Factor 4: variety, analytical/decision complexity\n");
    prompt.append("- Factor 5: impact, scope, organizational effect\n");
    prompt.append("- Factors 6-7: contact levels and purposes\n");
    prompt.append("- Factors 8-9: physical/environmental conditions\n\n");

    prompt.append("FACTOR CONTENTS:\n");
    for (int i = 1; i <= 9; i++) {
        String key = "Factor " + i;
        String content = factors.getOrDefault(key, "");
        if (!content.isEmpty()) {
            prompt.append(String.format("FACTOR %d:\n%s\n", i, content));
        }
    }

    prompt.append("\nReturn JSON in this format:\n");
    prompt.append("{\n  \"factors\": { /* header, content, level, points, rationale */ },\n");
    prompt.append("  \"totalPoints\": [sum of points],\n");
    prompt.append("  \"gradeRange\": \"[official OPM points range]\",\n");
    prompt.append("  \"finalGrade\": \"GS-XX\"\n");
    prompt.append("}\n\n");

    prompt.append("INSTRUCTIONS:\n");
    prompt.append("1. Analyze thoroughly, even long content.\n");
    prompt.append("2. Assign correct level matching factor number, using above points.\n");
    prompt.append("3. Include rationale for each factor.\n");
    prompt.append("4. Only include factors with content.\n");
    prompt.append("5. Enhance content only for clarity, preserving meaning.\n");
    prompt.append("6. For grade range, return only official OPM point ranges, no text labels.\n");
    ...
    try {
        ...
        // Correct factor headers and levels
        @SuppressWarnings("unchecked")
        Map<String, Object> resultFactors = (Map<String, Object>) result.get("factors");
        Map<String, Map<String, String>> levelPointMap = Map.of(
            "1", Map.of("200","1-1","350","1-2","500","1-3","750","1-4","950","1-5","1250","1-6","1550","1-7","1850","1-8","2210","1-9"),
            "2", Map.of("25","2-1","125","2-2","275","2-3","450","2-4","650","2-5"),
            "3", Map.of("25","3-1","125","3-2","275","3-3","450","3-4","650","3-5"),
            "4", Map.of("25","4-1","75","4-2","150","4-3","225","4-4","325","4-5","450","4-6"),
            "5", Map.of("25","5-1","75","5-2","150","5-3","225","5-4","325","5-5","450","5-6"),
            "6", Map.of("10","6-1","25","6-2","60","6-3","110","6-4"),
            "7", Map.of("20","7-1","50","7-2","120","7-3","220","7-4"),
            "8", Map.of("5","8-1","20","8-2","50","8-3"),
            "9", Map.of("5","9-1","20","9-2","50","9-3")
        );
        ...
        for (String factorKey : resultFactors.keySet()) {
            ...
            correctedFactors.put(factorKey, factorData);
        }
