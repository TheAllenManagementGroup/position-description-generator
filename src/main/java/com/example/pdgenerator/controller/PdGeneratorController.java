...
/**
 * CRITICAL: Improved system detection with recursive key checking
 */
private boolean detectSystemFromExistingFactors(Map<String, String> factorHints, Map<String, Object> payload) {
    ...
    // Check factor hints (normalized keys)
    ...
    for (String key : allKeys) {
        ...
        if (normalized.equals("Factor 7") || normalized.endsWith("7_level")) has7 = true;
        if (normalized.equals("Factor 8") || normalized.endsWith("8_level")) has8 = true;
        if (normalized.equals("Factor 9") || normalized.endsWith("9_level")) has9 = true;
    }
    
    System.out.println("  Detection: 4A=" + has4A + ", 4B=" + has4B + ", 7=" + has7 + ", 8=" + has8 + ", 9=" + has9);
    ...
    // Check point values for GSSG vs FES scales
    for (Map.Entry<String, Object> entry : payload.entrySet()) {
        ...
        // GSSG-specific point values (Factor 1: 175, 350, 550, 775, 900)
        if (valStr.contains("775") || valStr.contains("900")) {
            System.out.println("  ✓ GSSG Supervisory (found GSSG point value)");
            return true;
        }
        
        // FES-specific high values (Factor 1: 1250, 1550, 1850)
        if (valStr.contains("1250") || valStr.contains("1550") || valStr.contains("1850")) {
            System.out.println("  ✓ FES Non-Supervisory (found FES point value)");
            return false;
        }
    }
