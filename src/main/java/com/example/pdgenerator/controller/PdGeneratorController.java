...
public Map<String, Object> regenerateFactors(@RequestBody Map<String, Object> payload) {
    try {
        ...
        // Try to infer the evaluation system (GSSG vs FES) from any provided Factor headers
        ...
        // Fallback to the supervisoryLevel parameter if the hints were inconclusive
        ...
        System.out.println("[regenerate-factors] System: " + (isSupervisory ? "GSSG (supervisory)" : "FES (non-supervisory)"));
