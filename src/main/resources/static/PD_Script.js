...
function splitPDSections(text) {
    ...
    text = text.replace(/(^|\n)(Introduction|INTRODUCTION|Major Duties|MAJOR DUTIES|Conditions of Employment|CONDITIONS OF EMPLOYMENT|Title and Series Determination|TITLE AND SERIES DETERMINATION|Fair Labor Standards Act Determination|FAIR LABOR STANDARDS ACT DETERMINATION)(\n|$)/g, '\n**$2**\n');

    // Clean up multiple consecutive newlines
    text = text.replace(/\n{3,}/g, '\n\n');

    // Section header regex for both formats
