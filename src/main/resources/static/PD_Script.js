...
window.formatGeneratedPD = function(pdText) {
    ...
    // FIX 1: Header spacing - add line breaks in header section
    ...
    // FIX 2: Separate HEADER and INTRODUCTION sections
    ...
    // FIX 3: Factor spacing - add space before parentheses in factor headers
    text = text.replace(
