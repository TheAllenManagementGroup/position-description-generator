            ...
            <div class="step-content">
                ...
                <div class="form-section">
                    <div class="form-group">
                        ...
                        >
                        <div class="form-help">
                            Enter your most specific organizational unit. We'll automatically detect the parent agency and sub-organization.
                        </div>
                    </div>
...
federalAgencyDropdown.addEventListener('change', function() {
    ...
    continueBtn.addEventListener('click', function() {
        if (formState.federalAgency && formState.subOrg) {
            ...
            renderPositionClassificationStep(document.getElementById('stepContent'));
        }
    });
