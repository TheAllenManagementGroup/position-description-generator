...
function renderJobClassificationStep(content) {
    ...
    // If 0301, clear position titles and allow free text entry
    if (is0301Series) {
                ...
                <div class="form-group">
                    ...
                    <div class="dropdown-wrapper">
                        <input class="form-input" id="positionTitleInput" autocomplete="off"
                            placeholder="${is0301Series ? 'Type position title...' : 'Search or type position title...'}"
                            value="${formState.positionTitle || ''}"
                            ${!formState.jobSeries ? 'disabled' : ''}
                        >
                        ${!is0301Series ? `<div class="dropdown-list" id="positionTitleDropdownList" style="display:none;"></div>` : ''}
                    </div>
    ...
    // Position Title logic
    const positionTitleInput = document.getElementById('positionTitleInput');
    if (is0301Series) {
        // Free text only, no dropdown
        positionTitleInput.removeAttribute('readonly');
        positionTitleInput.removeAttribute('disabled');
    ...
    // Organizational Title logic (always optional)
    ...
    function checkComplete() {
        ...
        const positionTitleFilled = positionTitleInput.value.trim() !== '';
        // Organizational title is always optional now
    ...
    jobSeriesInput.addEventListener('input', function() {
        ...
        // If user selects 0301, clear position title immediately and re-render
        if (this.value === '0301') {
