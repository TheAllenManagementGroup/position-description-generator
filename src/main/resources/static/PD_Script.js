...
function renderSidebar(currentStep) {
    ...
    steps.forEach((step, idx) => {
        ...
        const isUpcoming = stepNum > window.maxStepCompleted;
        ...
        if (isCompleted) {
            ...
            // Current: small white circle inside green circle
            ...
            // Upcoming: step number in dark teal, white circle with teal border, faded
        ...
        if (isCompleted || isCurrent) {
            highlightStyle = `background:${darkTeal}1a !important;`;
        } else {
        ...
        container.innerHTML += `
            <div class="${stepClass}" ${clickable} style="${highlightStyle}; box-shadow:none; border:none; min-height:40px; padding:8px 12px;">
                ${iconHtml}
                <div class="step-content">
                    <h4 style="color:#111827 !important; font-size:15px; font-weight:500;">${step.name}</h4>
                    <p style="color:#111827 !important; font-size:12px;">${step.description}</p>
                </div>
            </div>
        `;
    });
...
function renderUpdateSidebar(currentStep) {
    ...
    updateSteps.forEach((step, idx) => {
        ...
        let highlightStyle = '';
        if (isCompleted || isCurrent) {
            highlightStyle = `background:${darkTeal}1a !important; opacity:1;`;
        } else {
            highlightStyle = `background:#fff !important; opacity:0.4;`;
        }
