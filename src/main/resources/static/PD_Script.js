...
function formatUpdatedPD(sectionsObject) {
    ...
    // Section order (no extra formatting, just user content)
    const sectionOrder = [];
    ...
    // Always add summary sections if present in the original PD
    ...
    // Any remaining sections not already rendered
    ...
    // Build the formatted PD, using the actual section key as the header, NO extra formatting
    let formatted = '';
