...
function renderJobClassificationStep(content) {
    ...
    const is0301Series = formState.jobSeries === '0301' || !formState.jobSeries;
                ...
                <div class="form-group">
                    ...
                    <div class="dropdown-wrapper">
                        <input class="form-input" id="positionTitleInput" autocomplete="off"
                            ...
                            ${!formState.jobSeries && !is0301Series ? 'disabled' : ''}
                        >
                        <!-- No dropdown for 0301 or when no job series is selected -->
                        ${(!is0301Series && formState.jobSeries) ? `<div class="dropdown-list" id="positionTitleDropdownList" style="display:none;"></div>` : ''}
                    </div>
    ...
    // --- Always set up the position title input as a text field for 0301 or when no job series is selected ---
    const positionTitleInput = document.getElementById('positionTitleInput');
    if (is0301Series) {
        positionTitleInput.disabled = false;
        positionTitleInput.placeholder = "Type position title...";
