...
function undoSectionEdit(title) {
    ...
    if (!title) {
        console.error('No title provided to undoSectionEdit');
        return;
    }
    ...
    if (!textarea) {
        ...
        console.log('Available textareas:', Array.from(allTextareas).map(t => t.id));
        return;
    }
    ...
    if (!window.sectionEditStacks[currentKey]) {
        const initialValue = (pdSections && pdSections[currentKey]) || '';
        window.sectionEditStacks[currentKey] = [initialValue];
    }
    ...
    if (display) {
        ...
        console.warn('Display element not found for:', title);
    }
}
...
function resetSectionEdit(title) {
    ...
    if (!title) {
        console.error('No title provided to resetSectionEdit');
        return;
    }
    ...
    const currentKey = getCurrentSectionKey(title);
    const originalValue = (pdSections && pdSections[currentKey]) || '';
...
function cancelSectionEdit(title) {
    ...
    if (!title) {
        console.error('No title provided to cancelSectionEdit');
        return;
    }
