...
formState.gradeRange = data.gradeRange || '';
formState.totalPoints = data.totalPoints || '';
...
function setupGenerateButton() {
    ...
    btn.onclick = async function() {
        ...
        const payload = {
            ...
            samplePD: '',
            gsGrade: formState.gsGrade || '', // <-- from AI grade analysis
            gradeRange: formState.gradeRange || '', // <-- from AI grade analysis
            totalPoints: formState.totalPoints || '', // <-- from AI grade analysis
            supervisoryLevel: formState.supervisoryLevel || ''
        };
        ...
        try {
            ...
            // Handle streaming or non-streaming response as in your current code...
            // (Omitted for brevity, keep your existing streaming logic here)
