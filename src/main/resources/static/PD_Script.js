...
function renderDutiesStep(content) {
    if (!Array.isArray(formState.duties) || formState.duties.length < 6) {
        // If duties are missing or less than 6, fill with empty strings
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div style="margin-bottom:1rem;">
                ...
                <div id="aiRewriteResult" style="margin-top:1em; max-width:100%; overflow-x:auto; word-break:break-word; white-space:pre-line; background:#f3f4f6; border-radius:0.5em; padding:1em;"></div>
            </div>
            <div class="section-divider" style="margin: 1.5rem 0 1rem 0; border-bottom: 1px solid #e5e7eb;"></div>
            <h3 style="font-size: 1.15rem; color: #2563eb; font-weight: 600;">
                Enter Duties & Responsibilities Below
    ...
    // Custom renderDutyInputs to show numbers for each duty
    ...
    // Enhanced AI rewrite button logic to prevent bleed-off
    document.getElementById('aiRewriteBtn').onclick = async function() {
        ...
        try {
            ...
            // Display rewritten duties in a scrollable, wrapped container
            resultDiv.innerHTML = `
                <div style="margin-bottom:1em; max-width:100%; overflow-x:auto; word-break:break-word; white-space:pre-line; background:#f3f4f6; border-radius:0.5em; padding:1em;">
                    <strong>Rewritten Duties:</strong>
                    <pre style="margin:0; font-size:1em; background:none; border:none; white-space:pre-line; word-break:break-word;">${rewritten.join('\n')}</pre>
                </div>
