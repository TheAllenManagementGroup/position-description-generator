...
function renderJobClassificationStep(content) {
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint" style="color:#64748b; font-size:0.95em;">This is the working title used in your organization (e.g., 'Lead Contract Specialist').</div>
                </div>
    ...
    // Save organizational title to formState.organizationalTitle and positionTitle
    ...
    if (orgTitleInput) {
        orgTitleInput.addEventListener('input', function() {
            ...
            // If user enters a value, also set positionTitle to match
            if (this.value.trim()) {
                formState.positionTitle = this.value.trim();
            }
        });
    }
    ...
    setTimeout(() => {
        ...
        if (jobSeriesSearch) jobSeriesSearch.blur();
        if (subSeriesSelect) subSeriesSelect.blur();
