...
function formatUpdatedPD(sectionsObject) {
    ...
    sectionOrder.forEach(sectionKey => {
        ...
        if (sectionKey === 'Total Points' || sectionKey === 'Final Grade' || sectionKey === 'Grade Range') {
            console.log(`Processing summary section: ${sectionKey}, found key: ${key}`);
        }
        
        // Special handling for summary sections - show header even with empty content
    ...
    // Add any remaining sections not in the preferred order (including summary sections if not already added)
    Object.keys(cleanedSections).forEach(key => {
