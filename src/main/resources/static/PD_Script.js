...
window.formatGeneratedPD = function(pdText) {
    ...
    [
        ...
        'EVALUATION SUMMARY:', 'CONDITIONS OF EMPLOYMENT:', 'TITLE AND SERIES DETERMINATION:', 'FAIR LABOR STANDARDS ACT DETERMINATION:'
    ].forEach(section => {
        text = text.replace(new RegExp(`\\*\\*${section.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&')}\\*\\*`, 'gi'), `\n\n**${section}**\n`);
