// Define steps immediately and attach to window for global access
window.steps = [
...
function renderUpdateSidebar(currentStep) {
    ...
    container.innerHTML = '';
    window.updateSteps.forEach((step, idx) => {
        const stepNum = idx + 1;
