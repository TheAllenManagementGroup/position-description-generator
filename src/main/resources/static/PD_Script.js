...
function renderDutiesStep(content) {
    ...
    if (freshAiBtn) {
        freshAiBtn.addEventListener('click', async function () {
            ...
            if (!dutiesText) {
                resultDiv.innerHTML = `<div class="alert alert-warning">Please enter duties to rewrite.</div>`;
                return;
            }
            ...
            try {
                            ...
                            if (data !== '[DONE]') {
                                try {
                                    ...
                                    if (parsed.rewritten) {
                                        ...
                                        resultDiv.innerHTML = `<div style="background:#f3f4f6; border-radius:0.5em; padding:1em; white-space:pre-line;">${rewrittenText}</div>`;
                                    }
                                } catch (e) {}
                            }
                        }
                ...
                resultDiv.innerHTML = `<div class="alert alert-warning">Error: ${err.message}</div>`;
            }
        });
    }
