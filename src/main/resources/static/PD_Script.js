        ...
        if (/^Total Points:/i.test(safeTitle)) {
            ...
            sectionDiv.innerHTML = `
                <div class="section-header">
                    <span class="section-title-label" style="font-weight:700; font-size:1.1em;">Total Points: ${value}</span>
                </div>
            `;
            ...
            sectionDiv.innerHTML = `
                <div class="section-header">
                    <span class="section-title-label" style="font-weight:700; font-size:1.1em;">Final Grade: ${value}</span>
                </div>
            `;
            ...
            sectionDiv.innerHTML = `
                <div class="section-header">
                    <span class="section-title-label" style="font-weight:700; font-size:1.1em;">Grade Range: ${value}</span>
                </div>
            `;
        }
        return sectionDiv;
