...
function renderSidebar(currentStep) {
    ...
    steps.forEach((step, idx) => {
        ...
        if (isCompleted) {
            ...
            // Current: step number in white, teal filled circle with green border
            iconHtml = `<div class="step-icon current" style="background:${darkTeal};color:#fff;border:2px solid ${green};font-weight:700;">
                ${stepNum}
            </div>`;
        } else {
            // Upcoming: step number in dark teal, white circle with teal border
            iconHtml = `<div class="step-icon upcoming" style="background:#fff;color:${darkTeal};border:2px solid ${darkTeal};font-weight:700;">
                ${stepNum}
            </div>`;
        }
        ...
        if (isCompleted || isCurrent) {
            ...
            highlightStyle = `background:#fff !important;border-color:${darkTeal} !important;`;
        }
        ...
        container.innerHTML += `
            <div class="${stepClass}" style="${highlightStyle}">
                ...
                <div class="step-content">
                    <h4 style="color:#111827 !important;">${step.name}</h4>
                    <p style="color:#111827 !important;">${step.description}</p>
                </div>
            </div>
        `;
    });
...
function setupGenerateButton() {
    ...
    btn.onclick = async function() {
        ...
        // --- FIX: Always use formState.duties ---
