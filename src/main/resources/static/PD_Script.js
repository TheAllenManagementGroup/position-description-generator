...
function renderAgencySetupStep(content) {
    ...
    content.innerHTML = `
        <div class="card" style="max-width: 72rem; margin: 0 auto;">
            <div class="card-header">
                <div class="card-title" style="display: flex; align-items: center; gap: 0px;">
                    <span class="step-icon" style="background: #fff; color: #000; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
