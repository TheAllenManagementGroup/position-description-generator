...
function renderDutiesGradeAnalysis(data) {
    ...
    try {
        ...
        // --- CLEANUP: Remove spinner/message and any redundant/partial text above the first factor ---
        // Remove "Generating evaluation statement..." and any text before the first "**Factor"
        let cleaned = fullText.replace(/^(Generating evaluation statement\.\.\.\s*)?/i, '');
        // Remove any lines before the first "**Factor" or "Factor 1"
