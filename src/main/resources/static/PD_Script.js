...
function renderSidebar(currentStep) {
    ...
    if (typeof window.maxStepVisited === 'undefined' || currentStep > window.maxStepVisited) {
        window.maxStepVisited = currentStep;
    }
    ...
    steps.forEach((step, idx) => {
        ...
        const isUpcoming = stepNum > window.maxStepVisited;
        ...
        // Completed and current steps get light blue background
        let highlightStyle = '';
...
function renderUpdateSidebar(currentStep) {
    ...
    // Track the highest update step the user has visited
    if (typeof window.maxUpdateStepVisited === 'undefined' || currentStep > window.maxUpdateStepVisited) {
        window.maxUpdateStepVisited = currentStep;
    }
    ...
    updateSteps.forEach((step, idx) => {
        ...
        const isCompleted = stepNum < currentStep;
        const isCurrent = stepNum === currentStep;
        const isUpcoming = stepNum > window.maxUpdateStepVisited;
        ...
        <div class="card" style="max-width: 72rem; margin: 0 auto;">
            ...
            <div class="card-header">
                <div class="card-title" style="display: flex; align-items: center; gap: 10px;">
                    <span class="step-icon" style="background: #ffffffff; color: #000000ff; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
