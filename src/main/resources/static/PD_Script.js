...
function renderAgencySetupStep(content) {
                ...
                <div class="form-section">
                    <div class="form-row">
                        <div class="form-group form-group-half">
                            ...
                            <div class="dropdown-wrapper">
                                <select class="form-select" id="federalAgencyDropdown" style="width:100%;padding:0.5em 1em;border-radius:0.5em;border:1px solid #d1d5db;font-size:1em;background:#fff;appearance:none;">
                                    <option value="">Select department or agency</option>
                                ...
                                <span class="dropdown-arrow" style="position:absolute;right:1em;top:50%;transform:translateY(-50%);pointer-events:none;">
                        ...
                        <div class="form-group form-group-half">
                            ...
                            <div class="dropdown-wrapper">
                                <select class="form-select" id="subOrgDropdown" style="width:100%;padding:0.5em 1em;border-radius:0.5em;border:1px solid #d1d5db;font-size:1em;background:#fff;appearance:none;" ${!formState.federalAgency ? 'disabled' : ''}>
    ...
    // Setup dropdowns (no autocomplete)
    ...
    // Populate sub-orgs when agency changes
    federalAgencyDropdown.addEventListener('change', function() {
        ...
        subOrgDropdown.disabled = !this.value;
        if (this.value) {
            const agency = agencyData.find(a => a.name === this.value);
            if (agency) {
                agency.subOrgs.forEach(subOrg => {
                    const option = document.createElement('option');
                    option.value = subOrg;
                    option.textContent = subOrg;
                    if (formState.subOrg === subOrg) option.selected = true;
    ...
    function updateContinueButton() {
        const canContinue = (
            federalAgencyDropdown.value &&
            subOrgDropdown.value &&
    ...
    if (formState.federalAgency) {
        const agency = agencyData.find(a => a.name === formState.federalAgency);
        if (agency) {
            subOrgDropdown.innerHTML = `<option value="">Select sub-organization</option>`;
            agency.subOrgs.forEach(subOrg => {
                const option = document.createElement('option');
