...
function splitPDSections(text) {
    ...
    for (let i = 0; i < matches.length - 1; i++) {
        ...
        // Skip FACTOR EVALUATION - COMPLETE ANALYSIS and EVALUATION SUMMARY sections
        if (/FACTOR EVALUATION.*COMPLETE ANALYSIS/i.test(header) || /^EVALUATION SUMMARY$/i.test(header)) {
            continue;
        }
