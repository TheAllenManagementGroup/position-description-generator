            ...
            <div class="card-content" style="padding: 1.5rem;">
                <div class="upload-methods">
                    ...
                    <div class="upload-method-card sample">
                        <div class="upload-method-content">
                            <div class="upload-method-header">
                                <div class="upload-method-icon sample" style="display: flex; align-items: center; justify-content: center; width: 48px; height: 48px; background: #f3f4f6; border-radius: 12px;">
