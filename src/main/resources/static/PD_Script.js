...
window.formatGeneratedPD = function(pdText) {
    ...
    // Fix header elements to be on separate lines
    ...
    // Ensure Introduction content starts on new line after header
    ...
    // Pattern: Factor 1 – Knowledge Required Level 1-7, 1250 Points
    text = text.replace(
